    ...
    public class Area : List<AreaDefiner>
    {
        ...
        public static Vector3 MoveMeThereOnlyIfValidCheckEverything(List<Area> l_areas, Entity entity, Vector3 MovementModifier)
        {
            try
            {
                ...
                {
                    VectorArea = MoveMeThereOnlyIfValid(area.L_AreaDefiners, entity, MovementModifier, StrideUtilityAssistant.Axis.Y);
        ...
        //Check if the move of one specific entity is valid inside the area generated by the list, and if it is, allow it to move, otherwise will return the original position of the entity.
        public static Vector3 MoveMeThereOnlyIfValid(List<AreaDefiner> l_areaDefiners, Entity entity, Vector3 MovementModifier, StrideUtilityAssistant.Axis IgnoredAxis = StrideUtilityAssistant.Axis.Z)
        {
            try
            {
                AreaDefiner NW = null;
                ...
                if (IgnoredAxis == StrideUtilityAssistant.Axis.Z)
                {
            ...
            try
            {
                if ((a.Point.Item2.Y < 0 && b.Point.Item2.Y < 0) || (a.Point.Item2.Y > 0 && b.Point.Item2.Y > 0))
                {
                    if (a.Point.Item2.Y > b.Point.Item2.Y)
                    {
                        ...
                        variance = Map_Editor_HoD.SerializedVector3.ConvertToVector3(tempVect3 - a.Point.Item2);
        ...
        public Area FromJson(string json)
        {
            ...
            try
            {
                ...
                this.Name = StrideUtilityAssistant.ExtractValue(txt, "Name").Replace("\"", "");
